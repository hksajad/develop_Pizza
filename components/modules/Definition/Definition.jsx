...
const Definition = () => {
  return (
    <div className="Definition mt-[100px]">
      <h3 className="text-[1.5rem] text-[#53c60b]">Who We Are?</h3>
      <p className="text-justify text-gray-600 font-medium	leading-[30px] mt-[10px]">
        DevelopFood company was founded in 2009 by Garrett Camp and Travis
